...
|---|---|---|
| 2026-06-30 | **v2.5.5** · Executable scripts relocated from test/ to scripts/ (lifting export-ignore for ZIP users); SKILL.md and TESTING.md paths updated accordingly; Issue ④ zero-baseline course constraints (audience declaration + concept warm-up + boundary cases/opt-out rules/retry fallback + coverage check in integrity test + F2-9/F2-10); verify.sh new warm-up/wikilink check sections | That seems a bit arrogant |
